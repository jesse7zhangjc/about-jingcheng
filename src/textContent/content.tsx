...
const experiences: IExperience[] = [
  {
    ...
    descriptions: [
      'Build complex customer-facing user interfaces for new data wrangling AWS Consoles (e.g. AWS Glue DataBrew and other unreleased projects) with React',
      'Integrate back-end APIs including AWS Glue, S3services, etc. to support front-end interactive user interfaces',
...
const projects: IProject[] = [
  {
    ...
    projectHref: 'https://jingchengzhang.me',
