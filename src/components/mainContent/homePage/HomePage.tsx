...
const HomePage = () => {
  ...
  return (
    <Transition animation="fade up" duration={animationDuration} visible={showContent}>
      <Container className="home-page">
        ...
        <Container className="home-page-content-container" textAlign="justified">
          ...
          <Header size="small">I like building things. I am a Software Development Engineer at Amazon Web Services. Before Amazon I was at Byton, Faraday Future and BYD Coach and Bus building web apps to better EV manufacturing experience.</Header>
        </Container>
      </Container>
    </Transition>
  );
